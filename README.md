...
```bash
node /Users/deng/ai/chrome-bridge-mcp/src/server.js
```
...
claude mcp add -s user --transport stdio chrome-bridge \
  ...
  --env CHROME_BRIDGE_RUNTIME=/Users/deng/runtime/.chrome-bridge-mcp \
  -- /Users/deng/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin/node \
  /Users/deng/ai/chrome-bridge-mcp/src/server.js
```
...
command = "/Users/deng/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin/node"
args = ["/Users/deng/ai/chrome-bridge-mcp/src/server.js"]
...
```bash
/Users/deng/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin/node \
  /Users/deng/ai/chrome-bridge-mcp/bin/chrome-bridge-cli.js \
...
- 可选 LaunchAgent 描述文件：`~/Library/LaunchAgents/com.deng.chrome-bridge-mcp.plist`
...
```text
/Users/deng/ai/chrome-bridge-mcp/reports
```
...
```text
/Users/deng/ai/chrome-bridge-mcp/reports/manual-google-*.json
/Users/deng/ai/chrome-bridge-mcp/reports/manual-google-*.md
```
...
```text
/Users/deng/ai/chrome-bridge-mcp/reports/manual-google-ai-chat-*.json
/Users/deng/ai/chrome-bridge-mcp/reports/manual-google-ai-chat-*.md
```
